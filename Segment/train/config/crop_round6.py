...
load_from = './checkpoints/results/crop_fakeT2_epoch90_round6_0627/crop_round3_0615_epoch_105.pth'
work_dir = './checkpoints/results/crop_fakeT2_epoch90_round6_0627'
