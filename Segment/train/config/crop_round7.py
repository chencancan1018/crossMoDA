...
# patch_size = [40, 320, 320] # for coarse- and fine-seg
patch_size = [40, 384, 384] # for coarse- and fine-seg
...
data = dict(
    ...
    train=dict(
        ...
        dst_list_file='./checkpoints/predata_fakeT2_round6/train_0.lst',
        data_root='./checkpoints/predata_fakeT2_round6/',
        patch_size=patch_size,
        sample_frequent=3,
        pipelines=[
            dict(
    ...
    val=dict(
        type='CropSegSampleDataset', # for coarse segmentation
        dst_list_file='./checkpoints/predata_fakeT2_round6/val_0.lst',
        data_root='./checkpoints/predata_fakeT2_round6/',
        patch_size=patch_size,
        sample_frequent=1,
        pipelines=[],
...
load_from = './checkpoints/results/crop_fakeT2_epoch90_round6_0627/epoch_180.pth'
work_dir = './checkpoints/results/crop_fakeT2_epoch90_round7_0628'
