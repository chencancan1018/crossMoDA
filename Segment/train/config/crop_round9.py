...
data = dict(
    ...
    train=dict(
        ...
        dst_list_file='./checkpoints/predata_fakeT2_round9/train_0.lst',
        data_root='./checkpoints/predata_fakeT2_round9/',
        patch_size=patch_size,
        sample_frequent=3,
        pipelines=[
            dict(
    ...
    val=dict(
        type='CropSegSampleDataset', # for coarse segmentation
        dst_list_file='./checkpoints/predata_fakeT2_round9/val_0.lst',
        data_root='./checkpoints/predata_fakeT2_round9/',
        patch_size=patch_size,
        sample_frequent=1,
        pipelines=[],
...
load_from = './checkpoints/results/crop_fakeT2_epoch90_round9_0703/epoch_120.pth'
work_dir = './checkpoints/results/crop_fakeT2_epoch90_round9_0707'
