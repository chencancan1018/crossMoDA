...
data = dict(
    ...
    train=dict(
        ...
        dst_list_file='./checkpoints/predata_fakeT2_round5/train_0.lst',
        data_root='./checkpoints/predata_fakeT2_round5/',
        patch_size=patch_size,
        sample_frequent=4,
        pipelines=[
            dict(
    ...
    val=dict(
        type='CropSegSampleDataset', # for coarse segmentation
        dst_list_file='./checkpoints/predata_fakeT2_round5/val_0.lst',
        data_root='./checkpoints/predata_fakeT2_round5/',
        patch_size=patch_size,
        sample_frequent=1,
        pipelines=[],
...
load_from = './checkpoints/results/crop_fakeT2_epoch90_round4_0619/epoch_200.pth'
work_dir = './checkpoints/results/crop_fakeT2_epoch90_round5_0621'
