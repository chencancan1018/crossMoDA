...
from starship.umtf.common.trainer import RUNNERS
...
class EpochBasedRunner(BaseRunner):
    ...
    def val(self, data_loader, **kwargs):
        ...
        for i, data_batch in enumerate(data_loader):
            ...
            loss_vars = outputs['log_vars'] 
            loss_vars['dice'] = 1 - 5 * loss_vars['loss_dice']
            outputs['log_vars'] = loss_vars #{'dice': loss_vars['dice']}
