...
from ..transform import MapTransform, Randomizable, RandomizableTransform
from .array import (
    AddChannel, AddCoordinateChannels, AddExtremePointsChannel,
    AsChannelFirst, AsChannelLast, CastToType, ClassesToIndices,
    ConvertToMultiChannelBasedOnBratsClasses, DataStats,
    EnsureChannelFirst, EnsureType,
    FgBgToIndices, Identity, IntensityStats,
    LabelToMask, Lambda, MapLabelValue,
    RemoveRepeatedChannel, RepeatChannel,
    SimulateDelay, SplitChannel, SqueezeDim,
    ToDevice, ToNumpy,
    ToPIL, TorchVision, ToTensor, Transpose,
)
from ..type_definitions import DtypeLike, KeysCollection, NdarrayOrTensor
from ..enums import PostFix, TraceKeys, TransformBackends
from ..utils import (
    no_collation, concatenate,
    extreme_points_to_image, get_extreme_points,
    convert_to_numpy, convert_to_dst_type,
    ensure_tuple, ensure_tuple_rep,
)
...
class Identityd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Identity`.
    """
...
class AsChannelFirstd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.AsChannelFirst`.
    """
...
class AsChannelLastd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.AsChannelLast`.
    """
...
class AddChanneld(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.AddChannel`.
    """
    ...
    def __init__(self, keys: KeysCollection, allow_missing_keys: bool = False) -> None:
        ...
        Args:
            keys: keys of the corresponding items to be transformed.
                See also: :py:class:`transforms.MapTransform`
            allow_missing_keys: don't raise exception if key is missing.
        """
        super().__init__(keys, allow_missing_keys)
...
class EnsureChannelFirstd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.EnsureChannelFirst`.
    """
...
class RepeatChanneld(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.RepeatChannel`.
    """
...
class RemoveRepeatedChanneld(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.RemoveRepeatedChannel`.
    """
...
class SplitChanneld(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.SplitChannel`.
...
class CastToTyped(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.CastToType`.
    """
...
class ToTensord(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ToTensor`.
    """
...
class EnsureTyped(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.EnsureType`.
...
class ToNumpyd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ToNumpy`.
    """
...
class Transposed(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Transpose`.
    """
...
class SqueezeDimd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.SqueezeDim`.
    """
...
class DataStatsd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.DataStats`.
    """
...
class SimulateDelayd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.SimulateDelay`.
    """
...
class Lambdad(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Lambda`.
...
class RandLambdad(Lambdad, RandomizableTransform):
    """
    Randomizable version :py:class:`transforms.Lambdad`, the input `func` may contain random logic,
    ...
    For more details, please check :py:class:`transforms.Lambdad`.
...
class LabelToMaskd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.LabelToMask`.
...
class FgBgToIndicesd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.FgBgToIndices`.
...
class ClassesToIndicesd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ClassesToIndices`.
...
class ConvertToMultiChannelBasedOnBratsClassesd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ConvertToMultiChannelBasedOnBratsClasses`.
...
class AddExtremePointsChanneld(Randomizable, MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.AddExtremePointsChannel`.
...
class TorchVisiond(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.TorchVision` for non-randomized transforms.
...
class RandTorchVisiond(Randomizable, MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.TorchVision` for randomized transforms.
    For deterministic non-randomized transforms of TorchVision use :py:class:`transforms.TorchVisiond`.
...
class MapLabelValued(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.MapLabelValue`.
    """
...
class IntensityStatsd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.IntensityStats`.
...
class ToDeviced(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ToDevice`.
    """
...
class AddCoordinateChannelsd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.AddCoordinateChannels`.
