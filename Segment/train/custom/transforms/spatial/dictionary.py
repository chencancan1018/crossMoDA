...
from ..croppad.array import CenterSpatialCrop, SpatialPad
from ..inverse import InvertibleTransform
from .array import AffineTransform, GaussianFilter
from .array import (
    Affine, AffineGrid, Flip, GridDistortion,
    Orientation, Rand2DElastic, Rand3DElastic, RandAffine,
    RandAxisFlip, RandFlip, RandGridDistortion, RandRotate,
    RandZoom, Resize, Rotate, Rotate90,
    Spacing, SpatialResample, Zoom,
)
from ..type_definitions import DtypeLike, KeysCollection, NdarrayOrTensor
from ..enums import GridSampleMode, GridSamplePadMode, InterpolateMode, NumpyPadMode, PytorchPadMode, PostFix, TraceKeys
from ..transform import MapTransform, RandomizableTransform
from ..utils import affine_to_spacing, convert_data_type, convert_to_dst_type, ensure_tuple, ensure_tuple_rep, fall_back_tuple, create_grid
from ..deprecate_utils import optional_import
...
class SpatialResampled(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.SpatialResample`.
...
class Spacingd(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Spacing`.
...
class Orientationd(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Orientation`.
...
class Rotate90d(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Rotate90`.
    """
...
class RandRotate90d(RandomizableTransform, MapTransform, InvertibleTransform):
    """
    Dictionary-based version :py:class:`transforms.RandRotate90`.
...
class Resized(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Resize`.
...
class Affined(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Affine`.
    """
...
class RandAffined(RandomizableTransform, MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.RandAffine`.
    """
...
class Rand2DElasticd(RandomizableTransform, MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Rand2DElastic`.
    """
...
class Rand3DElasticd(RandomizableTransform, MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Rand3DElastic`.
    """
...
class Flipd(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Flip`.
...
class RandFlipd(RandomizableTransform, MapTransform, InvertibleTransform):
    """
    Dictionary-based version :py:class:`transforms.RandFlip`.
...
class RandAxisFlipd(RandomizableTransform, MapTransform, InvertibleTransform):
    """
    Dictionary-based version :py:class:`transforms.RandAxisFlip`.
...
class Rotated(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Rotate`.
...
class RandRotated(RandomizableTransform, MapTransform, InvertibleTransform):
    """
    Dictionary-based version :py:class:`transforms.RandRotate`
...
class Zoomd(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.Zoom`.
...
class RandZoomd(RandomizableTransform, MapTransform, InvertibleTransform):
    """
    Dict-based version :py:class:`transforms.RandZoom`.
...
class GridDistortiond(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.GridDistortion`.
    """
...
class RandGridDistortiond(RandomizableTransform, MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.RandGridDistortion`.
    """
