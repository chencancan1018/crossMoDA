...
from ..utils import (
    meshgrid_ij, moveaxis,
    convert_to_dst_type, convert_to_tensor, look_up_option
)
...
class RandSmoothDeform(RandomizableTransform):
    ...
    def set_field_mode(self, mode: Union[InterpolateMode, str]) -> None:
        self.sfield.set_mode(mode)

    def set_grid_mode(self, mode: Union[GridSampleMode, str]) -> None:
        self.grid_mode = mode
