...
from ..type_definitions import DtypeLike, NdarrayOrTensor, KeysCollection
from ..enums import PostFix
from .array import (
    AdjustContrast, GaussianSharpen, GaussianSmooth,
    GibbsNoise, HistogramNormalize, KSpaceSpikeNoise,
    MaskIntensity, NormalizeIntensity, RandAdjustContrast,
    RandBiasField, RandCoarseDropout, RandCoarseShuffle,
    RandGaussianNoise, RandGaussianSharpen, RandGaussianSmooth,
    RandGibbsNoise, RandHistogramShift, RandKSpaceSpikeNoise,
    RandRicianNoise, RandScaleIntensity, RandShiftIntensity,
    RandStdShiftIntensity, SavitzkyGolaySmooth, ScaleIntensity,
    ScaleIntensityRange, ScaleIntensityRangePercentiles,
    ShiftIntensity, StdShiftIntensity, ThresholdIntensity,
)
from ..transform import MapTransform, RandomizableTransform
from ..utils import is_positive, ensure_tuple, ensure_tuple_rep
...
class RandGaussianNoised(RandomizableTransform, MapTransform):
    """
    Dictionary-based version :py:class:`transforms.RandGaussianNoise`.
...
class RandRicianNoised(RandomizableTransform, MapTransform):
    """
    Dictionary-based version :py:class:`transforms.RandRicianNoise`.
...
class ShiftIntensityd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ShiftIntensity`.
    """
...
class RandShiftIntensityd(RandomizableTransform, MapTransform):
    """
    Dictionary-based version :py:class:`transforms.RandShiftIntensity`.
    """
...
class RandStdShiftIntensityd(RandomizableTransform, MapTransform):
    """
    Dictionary-based version :py:class:`transforms.RandStdShiftIntensity`.
    """
...
class RandScaleIntensityd(RandomizableTransform, MapTransform):
    """
    Dictionary-based version :py:class:`transforms.RandScaleIntensity`.
    """
...
class RandBiasFieldd(RandomizableTransform, MapTransform):
    """
    Dictionary-based version :py:class:`transforms.RandBiasField`.
    """
...
class NormalizeIntensityd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.NormalizeIntensity`.
...
class ThresholdIntensityd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ThresholdIntensity`.
...
class ScaleIntensityRanged(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ScaleIntensityRange`.
...
class AdjustContrastd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.AdjustContrast`.
    ...
    Args:
        keys: keys of the corresponding items to be transformed.
            See also: transforms.MapTransform
...
class ScaleIntensityRangePercentilesd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ScaleIntensityRangePercentiles`.
...
class MaskIntensityd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.MaskIntensity`.
...
class SavitzkyGolaySmoothd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.SavitzkyGolaySmooth`.
...
class GaussianSmoothd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.GaussianSmooth`.
...
class RandGaussianSharpend(RandomizableTransform, MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.GaussianSharpen`.
...
class RandHistogramShiftd(RandomizableTransform, MapTransform):
    """
    Dictionary-based version :py:class:`transforms.RandHistogramShift`.
...
class KSpaceSpikeNoised(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.KSpaceSpikeNoise`.
...
class RandKSpaceSpikeNoised(RandomizableTransform, MapTransform):
    """
    Dictionary-based version of :py:class:`transforms.RandKSpaceSpikeNoise`.
...
class HistogramNormalized(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.HistogramNormalize`.

    Args:
        keys: keys of the corresponding items to be transformed.
            See also: :py:class:`transforms.compose.MapTransform`
