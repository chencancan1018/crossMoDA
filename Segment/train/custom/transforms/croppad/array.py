...
from ..type_definitions import IndexSelection, NdarrayOrTensor
from ..utils import (
    ...
    is_positive, map_binary_to_indices,
...
from ..utils import floor_divide, maximum
from ..enums import Method, NumpyPadMode, PytorchPadMode, TransformBackends
from ..transform import Randomizable, Transform
...
class DivisiblePad(Transform):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        See also :py:class:`transforms.SpatialPad`
        """
        self.k = k
...
class RandScaleCrop(RandSpatialCrop):
    """
    Subclass of :py:class:`transforms.RandSpatialCrop`. Crop image with
...
class BoundingRect(Transform):
    ...
    def __call__(self, img: NdarrayOrTensor) -> np.ndarray:
        """
        See also: :py:class:`transforms.utils.generate_spatial_bounding_box`.
        """
        bbox = []
