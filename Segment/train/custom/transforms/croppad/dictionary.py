...
from ..type_definitions import IndexSelection, KeysCollection, NdarrayOrTensor
from ..enums import Method, NumpyPadMode, PytorchPadMode, PostFix, TraceKeys
from ..enums import ImageMetaKey as Key
from ..utils import(
    get_random_patch, get_valid_patch_size,
    generate_label_classes_crop_centers,
    generate_pos_neg_label_crop_centers,
    is_positive, 
    map_binary_to_indices, map_classes_to_indices,
    weighted_patch_samples,
    ensure_tuple, ensure_tuple_rep, fall_back_tuple
)

from .array import (BorderPad, BoundingRect, CenterSpatialCrop,
    CropForeground, DivisiblePad, RandCropByLabelClasses, 
    RandCropByLabelClasses, RandCropByPosNegLabel,
    ResizeWithPadOrCrop, SpatialCrop, SpatialPad
)
from ..inverse import InvertibleTransform
from ..transform import MapTransform, Randomizable
...
class SpatialPadd(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.SpatialPad`.
        ...
        **kwargs,
        ...
        Args:
            keys: keys of the corresponding items to be transformed.
                See also: :py:class:`transforms.transform.MapTransform`
...
class DivisiblePadd(MapTransform, InvertibleTransform):
    ...
    Dictionary-based wrapper of :py:class:`transforms.DivisiblePad`.
    """
...
class SpatialCropd(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.SpatialCrop`.
...
class CenterSpatialCropd(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.CenterSpatialCrop`.
    If a dimension of the expected ROI size is bigger than the input image size, will not crop that dimension.
    So the cropped result may be smaller than the expected ROI, and the cropped results of several images may
    not have exactly the same shape.
...
class CenterScaleCropd(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.CenterScaleCrop`.
...
class RandScaleCropd(RandSpatialCropd):
    """
    Dictionary-based version :py:class:`transforms.RandScaleCrop`.
...
class RandSpatialCropSamplesd(Randomizable, MapTransform, InvertibleTransform):
    """
    Dictionary-based version :py:class:`transforms.RandSpatialCropSamples`.
...
class RandCropByPosNegLabeld(Randomizable, MapTransform, InvertibleTransform):
    """
    Dictionary-based version :py:class:`transforms.RandCropByPosNegLabel`.
...
class RandCropByLabelClassesd(Randomizable, MapTransform, InvertibleTransform):
    """
    Dictionary-based version :py:class:`transforms.RandCropByLabelClasses`.
...
class ResizeWithPadOrCropd(MapTransform, InvertibleTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.ResizeWithPadOrCrop`.
...
class BoundingRectd(MapTransform):
    """
    Dictionary-based wrapper of :py:class:`transforms.BoundingRect`.
