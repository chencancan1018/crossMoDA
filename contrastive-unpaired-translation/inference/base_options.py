...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            '--dataroot', type=str, 
            default='/home/tx-deepocean/Data/Project/crossMoDA/data/crossmoda23_training/TrainingSource/img',
        ...
        parser.add_argument('--epoch', type=str, default='170', help='which epoch to load? set to latest to use latest cached model')
